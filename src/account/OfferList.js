...
const BuyTypography = withStyles({
  root: {
    ...
    '&::before': {
      ...
      height: '200%',
      background: (theme) =>
        `radial-gradient(circle, ${alpha('#007B55', 0.3)} 0%, transparent 50%)`,
...
const SellTypography = withStyles({
  root: {
    ...
    '&::before': {
      ...
      height: '200%',
      background: (theme) =>
        `radial-gradient(circle, ${alpha('#B72136', 0.3)} 0%, transparent 50%)`,
      animation: 'blob 15s ease-in-out infinite',
      opacity: 0.7,
      filter: 'blur(10px)',
      transform: 'scale(1.2)'
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="left">
                      ...
                      >
                        <Typography variant="s6" color="primary" noWrap>
