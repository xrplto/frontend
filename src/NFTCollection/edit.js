    ...
    <>
      ...
      <Stack spacing={2} mb={3}>
        ...
        <Stack spacing={1} pl={0}>
          ...
          <Typography variant="p3">
            <Typography variant="s2">Normal Bulk:</Typography> You can upload bulk NFTs and sell
            NFTs nomally with Mints.
          </Typography>
          <Typography variant="p3">
            <Typography variant="s2">Random Bulk:</Typography> You can upload bulk NFTs and sell
            NFTs randomly with Mints.
          </Typography>
          <Typography variant="p3">
            <Typography variant="s2">Sequence Bulk:</Typography> You can upload bulk NFTs and sell
              ...
              <>
                ...
                <CardWrapper>
                  ...
                  >
                    ...
                    <ImageIcon
                      fontSize="large"
                      sx={fileUrl4 ? { display: 'none' } : { width: 100, height: 100 }}
                    />
                  </Card>
                </CardWrapper>
              </>
