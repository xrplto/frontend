...
export default function RankingsTabs({ tab }) {
  ...
  return (
    <>
      ...
      {tabID === 0 && (
        <>
          <Typography variant="h1" fontSize='1.1rem' sx={{mt:{xs: 4, md: 4}, mb: 3 }}>The Best XRPL Tokens Based On The Latest Data</Typography>
          <Typography variant="s4" fontSize='1.1rem' sx={{mt:{xs: 4, md: 0}, mb: 3 }}>Our list for XRP Ledger tokens are created using the latest XRPL data, focusing directly on prices and user behavior.</Typography>
        </>
      )}

      {tabID === 1 && (
        <>
          <Typography variant="h1" fontSize='1.1rem' sx={{mt:{xs: 4, md: 4}, mb: 3 }}>Top XRPL Token Gainers And Losers Today</Typography>
          <Typography variant="s4" fontSize='1.1rem' sx={{mt:{xs: 4, md: 0}, mb: 3 }}>Which tokens on the XRP Ledger have experienced the largest gains or declines in the past 24 hours?</Typography>
        </>
      )}

      {tabID === 2 && (
        <>
          <Typography variant="h1" fontSize='1.1rem' sx={{mt:{xs: 4, md: 4}, mb: 3 }}>What Are The Trending XRPL Tokens</Typography>
          <Typography variant="s4" fontSize='1.1rem' sx={{mt:{xs: 4, md: 0}, mb: 3 }}>Here's a compilation of the currently trending XRP Ledger Tokens that are being frequently searched for on xrpl.to.</Typography>
        </>
      )}
...
{tabID === 3 && (
        <>
          <Typography variant="h1" fontSize='1.1rem' sx={{mt:{xs: 4, md: 4}, mb: 3 }}>What Are The Most Viewed Tokens On xrpl.to?</Typography>
          <Typography variant="s4" fontSize='1.1rem' sx={{mt:{xs: 4, md: 0}, mb: 3 }}>Find out which tokens are currently the most viewed by visitors on xrpl.to.</Typography>
        </>
      )}
...
{tabID === 4 && (
        <>
          <Typography variant="h1" fontSize='1.1rem' sx={{mt:{xs: 4, md: 4}, mb: 3 }}>New XRPL Tokens</Typography>
          <Typography variant="s4" fontSize='1.1rem' sx={{mt:{xs: 4, md: 0}, mb: 3 }}>Check out the new tokens added to the XRPL DEX in the last 30 days.</Typography>
        </>
      )}
      ...
      <Box ref={tabRef}>
        ...
        {tabID === 0 && (
        <>
          <Typography variant="h2" fontSize='1.1rem' sx={{mt:{xs: 4, md: 4}, mb: 3 }}>Frequently asked questions (FAQs)</Typography>
