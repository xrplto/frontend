...
export default function BidAskChart({ asks, bids }) {
    ...
    () => ({
      ...
      yAxis: {
        ...
        axisLabel: {
          ...
          fontSize: 9,
          formatter: function (value) {
            return value > 1000 ? (value / 1000).toFixed(0) + 'k' : fNumber(value);
          }
        }
      },
      tooltip: {
          ...
          areaStyle: {
            color: {
              ...
              colorStops: [
                {
                  offset: 0,
                  color: alpha('#00D9A3', 0.2)
                },
                {
                  offset: 1,
                  color: alpha('#00D9A3', 0.05)
                }
              ]
            }
          },
          ...
          areaStyle: {
            color: {
              ...
              colorStops: [
                {
                  offset: 0,
                  color: alpha('#FF6B6B', 0.2)
                },
                {
                  offset: 1,
                  color: alpha('#FF6B6B', 0.05)
                }
              ]
            }
          },
  ...
  if (!hasData) {
    return <ChartSkeleton variant="rectangular" height={isMobile ? 140 : 220} animation="wave" />;
  }
      ...
      <ChartContainer>
        <ChartHeader>
          <Stack direction="row" justifyContent="space-between" alignItems="center">
            ...
            {!isMobile && spread > 0 && (
              <DataIndicator>
                <Typography variant="caption">Spread: {fNumber(spread)}</Typography>
              </DataIndicator>
            )}
          </Stack>
        </ChartHeader>
