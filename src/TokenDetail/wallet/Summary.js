    ...
    return (
        <Stack sx={{pt:2, pl:2.5}}>
            ...
            >
                ...
                <Typography variant='para_content'>XRPL paper wallets are a secure way to hold your cryptocurrencies. Think of them like a savings account with no withdrawal limits. A paper wallet contains both the public and private key for your wallet. The wallet can be used to receive currencies from other people. It is also possible to send currency to this address if it is generated with a genuine random number generator (RNG).</Typography>
                <Typography variant='para_content'>They are simple, secure and offline alternatives to digital cryptocurrency wallets. They have all of the benefits of paper money while also providing the unique ability to securely cold-store digital currency without any possibility of a hacker or malware gaining access to your funds.</Typography>

                <Typography variant='wallet_h2'><Link href="https://gatehub.net/">Hot Wallets</Link></Typography>
                <Typography variant='para_content'>Currency hot wallets are also known as web wallets or online wallets.These types of wallets are used to make small, frequent payments while requiring the least amount of effort from the individual and/or organization.</Typography>
                <Typography variant='para_content'>Currency hot wallets are a digital wallet used to store cryptocurrency funds. A hot wallet is an online system and can be accessed from anywhere as it does not require any physical access to the unit. For example, <Link href="https://www.bitrue.com/">Bitrue</Link> is a popular exchange platform for buying cryptocurrency in the U.S. and Europe, but they also have a web-based digital wallet which allows users to store <Link href="https://coinmarketcap.com/currencies/xrp/">XRP</Link>, <Link href="https://xrpl.to/token/casinocoin-csc">Casino Coin</Link> and <Link href="https://xrpl.to/token/xpunks-xpunk">XPunks</Link>, among other XRPL tokens.</Typography>
                <Typography variant='para_content'><Link href="https://gatehub.net/">Gatehub</Link> is another popular hot wallet.</Typography>

                <Typography variant='wallet_h2'><Link href="https://xumm.app/">Cold Wallets</Link></Typography>
                <Typography variant='para_content'>Cold wallets refer to any method of storing cryptocurrency which keeps the private keys of your coins offline, preventing any form of hacking, stealing, or unauthorized access. Paper wallets and other cold wallets are considered to be more secure as compared to hot storage solutions.</Typography>


                <Typography variant='wallet_h2'>How to Use a XRP Wallet</Typography>
                <Typography variant='para_content'>THE XRP CLUB has a guide that teaches you <Link href="https://www.youtube.com/watch?v=kTm47-TpgsY">how to use a XRP wallet here</Link>.</Typography>
