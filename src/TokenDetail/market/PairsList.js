  ...
  return (
    <Stack>
      ...
      <Typography variant="h5" sx={{ pl: 2, pt: 2 }}>
        Pairs<span style={badge24hStyle}>24h</span>
      </Typography>
      <Box
        sx={{
          display: 'flex',
        ...
        >
          <TableHead>
            <TableRow>
              ...
              <TableCell align="left">Last 24h</TableCell>
              <TableCell align="left">
                Volume<span style={badge24hStyle}>24h</span>
              </TableCell>
              <TableCell align="left">
                Trades<span style={badge24hStyle}>24h</span>
              </TableCell>
          ...
          <TableBody>
            {
              ...
              pairs.map((row) => {
                ...
                let sparkline = '';
                if (id === 1) sparkline = curr1.md5;
                else if (curr2.issuer) sparkline = curr2.md5;
                ...
                return (
                  ...
                  >
                      ...
                      <Stack>
                        ...
                        {curr2.domain && (
                          ...
                          >
                            ...
                            <Typography
                              variant="subtitle2"
                              sx={{ color: darkMode ? '#5569ff' : '#007B55' }}
                            >
                              {curr2.domain}
                            </Typography>
                          </Link>
                    ...
                    >
                      {sparkline && (
                        <LoadChart
                          url={`${BASE_URL}/sparkline/${sparkline}?period=24h&${token.pro24h}`}
                        />
                      )}
                    </TableCell>
                    <TableCell align="left" sx={{ p: 0.5, pb: 0.5 }}>
                      <Stack>
                        <Stack direction="row" spacing={1} alignItems="center">
                          ...
                          <Typography variant="caption" sx={{ color: '#B72136' }}>
                            {name1}
                          </Typography>
                        </Stack>
                        <Stack direction="row" spacing={1} alignItems="center">
