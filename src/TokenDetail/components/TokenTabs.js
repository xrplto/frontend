  ...
  return (
    ...
    >
          ...
          return (
            ...
            >
              <img
                ...
                alt=""
                className={cn(
                  'w-3.5 h-3.5 shrink-0 object-cover',
      ...
      {searchOpen && (
        ...
        >
          <div
            className={cn('fixed inset-0 backdrop-blur-md', isDark ? 'bg-black/70' : 'bg-white/60')}
          />
          <div
            ref={searchRef}
            ...
            <div className="max-h-[400px] overflow-y-auto">
                ...
                <>
                  ...
                  {(query ? results.tokens : suggested.tokens).map((token) => (
                    ...
                    >
                      ...
                      {token.verified && (
                        <span className="w-4 h-4 rounded-full bg-emerald-500/20 text-emerald-500 flex items-center justify-center text-[9px]">
                          ✓
                        </span>
                      )}
                    </div>
                ...
                <>
                  <div
                    className={cn(
                      'px-3 py-2 text-[10px] font-medium uppercase tracking-wider',
                      isDark
                        ? 'text-white/30 border-t border-white/5'
              ...
              {query &&
                ...
                results.collections.length === 0 && (
                  <p
                    className={cn(
                      'px-4 py-6 text-[12px] text-center',
                      isDark ? 'text-white/30' : 'text-gray-400'
                    )}
                  >
                    No results found
