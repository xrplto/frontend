...
export default function ExtraDesc({ token }) {
  ...
  const { accountProfile, setLoading, openSnackbar, darkMode } =
  ...
  const onChangeMarketCalculation = async () => {
    ...
    try {
      ...
      res = await axios.post(
        `${BASE_URL}/admin/toggle_marketcap_formula`,
        body,
        {
          headers: {
                ...
                <Tooltip
                  title={
                    <Typography variant="body2">
                      ...
                      <br />
                      This concept is similar to free-float capitalization in
                      the stock market.
                      <br />
                      {omcf === 'yes'
        ...
        >
          <Stack direction="row" alignItems="center" gap={1} sx={{ pl: 3 }}>
            ...
            <Tooltip
              title={
                <Typography variant="body2">
                  A metric representing the trading volume of a token within the
                  past 24 hours.
                </Typography>
              }
            >
        ...
        <Grid item xs={12} md={4} sx={{ display: { xs: 'none', md: 'block' } }}>
          <Stack direction="row" alignItems="center" gap={1} sx={{ pl: 3 }}>
            ...
            <Tooltip
              title={
                <Typography variant="body2">
                  The number of tokens in circulation within the market and held
                  by the public is comparable to the concept of outstanding
          ...
          <Stack alignItems="center">
            <SupplyTypography variant="desc" sx={{ mt: 3, mb: 2 }}>
              {circulatingSupply}
            </SupplyTypography>
          </Stack>
