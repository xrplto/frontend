    ...
    >
            ...
            <Box sx={{ position: 'relative', zIndex: 1, flexShrink: 0, p: 0.5 }}>
              ...
              >
                <Tooltip title="Search image with Google Lens">
                  ...
                  >
                    <SearchIcon sx={{ fontSize: isXsMobile ? 12 : 16 }} />
                  </IconButton>
                </Tooltip>
              </Box>
            </Box>
                  ...
                  >
                    <Tooltip title="Search image with Google Lens">
                      <IconButton
                        ...
                        size="small"
                        sx={{
                          width: isXsMobile ? 24 : 28,
                          height: isXsMobile ? 24 : 28,
                          p: 0,
                          background: `linear-gradient(135deg, #4285f4 0%, #34a853 50%, #fbbc04 75%, #ea4335 100%)`,
                          color: 'white',
                          '&:hover': {
      ...
      >
        ...
        <DialogContent sx={{ p: 3, pt: 2 }}>
          ...
          {/* Safety guidelines - REMOVED FOR CONCISENESS */}
        </DialogContent>
      ...
      >
        ...
        <DialogContent sx={{ p: 3, pt: 2 }}>
          ...
          {/* Risk factors - REMOVED FOR CONCISENESS */}
        </DialogContent>
