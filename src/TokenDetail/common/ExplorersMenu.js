// Material
import { styled, Chip, Link, useTheme, Menu, MenuItem, Avatar, ListItemText } from '@mui/material';
    ...
    <>
      ...
      >
        <Link
          ...
          target="_blank"
          href={
            issuer === 'XRPL' ? `https://bithomp.com` : `https://bithomp.com/explorer/${issuer}`
          }
        ...
        <Link
          ...
          target="_blank"
          href={
            issuer === 'XRPL' ? `https://gatehub.net` : `https://gatehub.net/explorer/${issuer}`
          }
          rel="noreferrer noopener nofollow"
        >
          <MenuItem onClick={() => handleClose()} disableRipple sx={{ color: 'text.secondary' }}>
            <Avatar
              alt="Gatehub Explorer"
        ...
        >
          <MenuItem onClick={() => handleClose()} disableRipple sx={{ color: 'text.secondary' }}>
            <Avatar
              alt="xrpl.org Explorer"
              src="/static/xrpl-org.webp"
              sx={{ mr: 1, width: 24, height: 24 }}
            />
            <ListItemText
              primary="XRPL Explorer"
        ...
        >
          <MenuItem onClick={() => handleClose()} disableRipple sx={{ color: 'text.secondary' }}>
            <Avatar
              alt="XRPL Foundation Explorer"
              src="/static/explorerxrplf.svg"
              sx={{ mr: 1, width: 24, height: 24 }}
            />
            <ListItemText
              primary="XRPLF Explorer"
              primaryTypographyProps={{ variant: 'subtitle2' }}
            />
          </MenuItem>
        </Link>
