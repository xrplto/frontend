...
import { Stack, Typography, Box, Paper, Grid, IconButton, Tooltip, Tabs, Tab } from '@mui/material';
    ...
    <>
      <Box sx={{ mt: 5 }}>
        ...
        <ContentTypography variant="subtitle1" sx={{ mb: 2 }}>
          Listed below are the stats for NFT collections and individual assets that have sold for
          the highest prices. We list the data in descending order. Data can <br></br> be reordered
          by clicking on the column title. Only collections with a transaction in the last 30 days
          are included.
        </ContentTypography>
