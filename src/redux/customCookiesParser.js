...
import { persistJWT } from "src/utils/constants";

const encodeJwt = (str) => {

  return jwt.sign(JSON.stringify(str) || {}, persistJWT);
};

export const decodeJwt = (str) => {
  try {
    const decoded = jwt.verify(str, persistJWT);
