                  ...
                  <tbody>
                    {transactions.map((item, idx) => (
                      ...
                      >
                            ...
                            <div className="flex flex-col gap-0.5">
                              {item.brokerFeeXRP && (
                                <div className="flex items-center gap-1.5">
                                  <span className="text-[9px] text-orange-400 uppercase tracking-wide w-12">
                                    Broker
                                  </span>
                              ...
                              {item.royaltyAmountXRP && (
                                <div className="flex items-center gap-1.5">
                                  <span className="text-[9px] text-blue-400 uppercase tracking-wide w-12">
                                    Royalty
                                  </span>
                                  <span className="text-[10px] text-gray-400">
                                    ✕{item.royaltyAmountXRP}
                        ...
                        <td className="px-4 py-3">
                          {item.origin ? (
                            <span className="text-[11px] text-gray-500">
                              {item.origin === 'XRPL' &&
                              (item.broker === 'rpx9JThQ2y37FaGeeJP7PXDUVEXY3PHZSC' ||
                                item.SourceTag === 101102979)
                                ? 'XRP Cafe'
                                : item.origin}
                            </span>
                          ) : (
                        ...
                        <td className="px-4 py-3">
                          <span className="text-[11px] text-gray-500">{formatDate(item.time)}</span>
                        </td>
