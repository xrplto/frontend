...
const trimDecimal = (num, threshold = 4) => { // former f, fp
...
export function fCurrency3(number) {// option: Intl.NumberFormat but up to 20 minimumFractionDigits
...
export function fPercent(number) {
    if (number < 1)
        return trimDecimal(number, 2);//number.toFixed(2); //webxtor: as in other places//fp(number);
    else {
