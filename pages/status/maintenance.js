...
export async function getStaticProps() {
  ...
  ogp.desc =
    'Find top XRPL DEX token prices and charts, ranked by 24-hour trading volume. Get access to current and historical data for the XRP ecosystem. All XRPL tokens are automatically listed on XRPL.to.';
