    ...
    <Box>
      ...
      <Container maxWidth="xl" sx={{ mt: 4 }}>
        ...
        <Grid container spacing={3} sx={{ mb: 4 }}>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Box>
              ...
              <Typography variant="body2">
                We communicate openly and work as a team towards shared goals to build the ecosystem
                together.
              </Typography>
            </Box>
          </Grid>
          <Grid item xs={12} sm={6} md={4}>
            <Box>
              ...
              <Typography variant="body2">
                We are results-driven, passionate, and resilient. We learn fast and pick ourselves
                up when we fail.
              </Typography>
            </Box>
          </Grid>
          <Grid item xs={12} sm={6} md={4}>
            <Box>
              ...
              <Typography variant="body2">
                We execute responsibly and autonomously, empower those around us, and challenge the
                status quo.
              </Typography>
            </Box>
          </Grid>
          <Grid item xs={12} sm={6} md={4}>
            <Box>
              ...
              <Typography variant="body2">
                We accept critical feedback, treat everyone as equals, and remain modest about our
                success.
              </Typography>
            </Box>
          </Grid>
        ...
        <Box component="ul" sx={{ pl: 3, mb: 4 }}>
          <li>
            We are proud to offer competitive benefits that enable healthy and fulfilling careers at
            xrpl.to
          </li>
