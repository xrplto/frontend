              ...
              {news.length === 0 ? (
                <div className="py-16 text-center">
                  <div className="relative w-16 h-16 mx-auto mb-4">
                    ...
                    <div
                      className={cn(
                        'absolute top-2.5 left-1/2 -translate-x-1/2 w-13 h-13 rounded-full',
                        isDark ? 'bg-[#4285f4]' : 'bg-blue-400'
                      )}
                    ...
                    >
                      ...
                      <div
                        className={cn(
                          'absolute bottom-2.5 left-1/2 -translate-x-1/2 w-5 h-3 rounded-full',
                    ...
                    <div
                      className="absolute top-2.5 left-1/2 -translate-x-1/2 flex flex-col justify-start gap-[2px] pointer-events-none overflow-hidden rounded-full"
                      style={{ width: '52px', height: '52px' }}
                    >
                      {[...Array(12)].map((_, i) => (
                        <div
