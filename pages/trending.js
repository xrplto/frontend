...
export async function getStaticProps() {
  ...
  try {
    ...
    // Fetch tokens sorted by trendingScore in descending order
    const res = await axios.get(
      `${BASE_URL}/tokens?start=0&limit=100&sortBy=trendingScore&sortType=desc&filter=&tags=yes&showNew=false&showSlug=false`
    );
    ...
    console.log('API call for trending page took ' + (t2 - t1) + ' milliseconds.');
  } catch (error) {
